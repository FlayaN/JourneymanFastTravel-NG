...
public:
	static bool IsOnFlyingMount(RE::Actor* a_actor)
	{
		...
		static REL::Relocation<func_t> func{ REL::RelocationID(36877, 37901) };
		return func(a_actor);
	}
	...
	static bool CanFastTravel(RE::Actor* a_actor, bool a_arg2)
	{
		...
		static REL::Relocation<func_t> func{ REL::RelocationID(39372, 40444) };
	...
	static bool IsFastTravelEnabled()
	{
		...
		REL::Relocation<func_t> func{ REL::RelocationID(54848, 55481) };
		return func();
	}
	...
	static void EnableFastTravel(bool a_enable)
	{
		if (REL::Module::IsAE())
		{
			EnableFastTravelAE(a_enable);
		}
		else {
			EnableFastTravelSE(nullptr, nullptr, nullptr, a_enable);
		}
	}

	static RE::BSEventNotifyControl PostFastTravel();
private:
